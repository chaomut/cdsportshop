...
<html>
    <head>
        <title>Payment - Back Office</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="container">        
            <h2>PAYMENT</h2><hr>
            <div class="scrollBar" id="show-payment">

            </div>
        </div>

        <script>
            function updatePayment(payment_id, sale_id) {
            ...
            function cancelPayment(sale_id) {
                $.post("../php/check-payment_detail.php?operation=cancel", {
                    "sale_id": sale_id
                }, function (data) {
