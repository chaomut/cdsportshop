...
<html>
    <head>
        <title>Purchase - Back Office</title>
        <meta charset="UTF-8">
        ...
        <script src="../js/purchase_list.js"></script>
    </head>
    <body>
        ...
        <div class="container">        
            <h2>PURCHASE LIST</h2><hr>
            <div class="scrollBar" id="show-purchase">

            </div>
        </div>
        <script>
            function printPurchase(pur_id) {              
                if (pur_id !== '')
                {            
                    popupWindow = window.open(
                                '../php/purchase_invoice.php?pur_id=' + pur_id, 'popUpWindow', 'height=600,width=800');
                }
                else
